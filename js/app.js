jQuery(document).ready(function() {
    ...
    jQuery("#api")
        ...
        .on("fb:login", function(evt) {
            ...
            Handlebars.loadTemplate('//facebook-post-example/_views/profile-entry.hbs')
        ...
        .on("profile:load", function(evt, data) {
            ...
            Handlebars.loadTemplate('//facebook-post-example/_views/profile-jumbo.hbs')
                .then(function(hbTemplate) {
    ...
    jQuery("#posts_published")
        ...
        .on("posts:loaded", function(evt, response) {
            ...
            // display posts
            Handlebars.loadTemplate('//facebook-post-example/_views/post-entry.hbs')
                .then(function(hbTemplate) {
